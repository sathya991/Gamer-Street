  ...
  void signin() async {
    ...
    if (account != null) {
      ...
      if (userCredential.additionalUserInfo!.isNewUser ||
        ...
        _showMessage("No User found! try again or create GamerStreet Account ");
        print("user not found try again or create your account");
      ...
      _showMessage("You didn't Chosen your Google account");
      print("make sure you are logged into your gmail");
    }
  }
